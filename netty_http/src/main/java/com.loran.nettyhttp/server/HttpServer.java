...
public class HttpServer {
    ...
    private static EventLoopGroup group = new NioEventLoopGroup();//通过NIO方式接收客户端消息
    private static ServerBootstrap b = new ServerBootstrap();
    private static final boolean SSL = false;/*是否开启SSL模式*/

    /**
     * Netty创建全部都是实现AbstractBootstarp
     * 客户端是Bootstrap,服务端则是ServerBootstrap
     */
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            //关闭EventLoopGroup，释放所有资源包括创建的线程
